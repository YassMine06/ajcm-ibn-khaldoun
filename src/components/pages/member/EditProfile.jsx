  ...
  return (
    <div style={{ maxWidth: '700px', margin: '0 auto' }}>
      ...
      <div className="table-container" style={{ padding: '2rem', marginBottom: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
          <div style={{ position: 'relative', flexShrink: 0 }}>
            <div style={{ width: '80px', height: '80px', borderRadius: '50%', background: 'linear-gradient(135deg, var(--green-700), var(--green-800))', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '2rem', fontWeight: 800, color: 'var(--gold-400)' }}>
              M
            </div>
            <div style={{ position: 'absolute', bottom: 0, right: 0, width: '26px', height: '26px', borderRadius: '50%', background: 'var(--gold-500)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', boxShadow: '0 2px 8px rgba(0,0,0,0.2)' }}>
          ...
          <div>
            ...
            <button className="btn-ghost" style={{ fontSize: '0.8rem', padding: '0.4rem 0.9rem' }}>
      ...
      <div className="table-container" style={{ padding: '2rem' }}>
        ...
        {saved && (
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.75rem 1rem', background: 'var(--success-bg)', color: '#065f46', borderRadius: 'var(--radius-sm)', border: '1px solid #a7f3d0', marginBottom: '1.25rem', fontSize: '0.85rem', fontWeight: 500 }}>
